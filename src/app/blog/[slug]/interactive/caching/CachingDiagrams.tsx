        ...
        <foreignObject x={x - 10} y={y - 10} width={20} height={20}>
          <div
            style={{
              ...
              width: 20,
              height: 20,
              color: iconColor || "var(--muted-text)",
            }}
          >
            {icon}
          </div>
...
export function ExternalCacheDiagram() {
  ...
  return (
    <svg className="w-full" viewBox="0 0 440 150">
      ...
      />
      {step === 0 && (
        <Pkt key="step0" from={[70, 65]} to={[220, 65]} color="#3498db" />
      )}
      {step === 1 && (
        <>
      ...
      {edges.map((e, i) => (
        <g key={i}>
          <circle
            ...
            fill={C.cache.bg}
            stroke={
              step >= 3 && step <= 6 && e === tokyo ? "#e74c3c" : C.cache.border
            }
            strokeWidth={1.5}
          />
          <text
...
export function ClientCacheDiagram() {
  ...
  return (
    <svg className="w-full" viewBox="0 0 440 150">
      ...
      {step === 0 && (
        <g>
          <rect
            ...
            strokeWidth={1}
          />
          <text x={98} y={32} textAnchor="middle" fontSize={9} fill="#2ecc71">
            Local Cache
          </text>
        </g>
      )}
      ...
      {step === 3 && (
        <Pkt key="step3" from={[120, 65]} to={[320, 65]} color="#3498db" />
      )}
    </svg>
  );
}
  ...
  return (
    <svg className="w-full" viewBox="0 0 440 170">
      ...
      <text
        ...
        textAnchor="middle"
        fontSize={9}
        fill={step <= 1 ? "#2ecc71" : "var(--muted-text)"}
        fontWeight={600}
      >
        Local Cache
      </text>
      ...
      <rect
        ...
        strokeWidth={1.5}
      />
      <foreignObject x={368} y={48} width={20} height={20}>
        <div
          style={{
            display: "flex",
            alignItems: "center",
...
export function CacheAsideDiagram() {
  ...
  return (
    <svg className="w-full" viewBox="0 0 440 150">
      ...
      {step === 2 && (
        <Pkt key="step2" from={[70, 65]} to={[370, 65]} color="#3498db" />
      )}
      {step === 3 && (
        <Pkt key="step3" from={[370, 65]} to={[70, 65]} color="#2ecc71" />
      )}
      {step === 4 && (
        <Pkt key="step4" from={[70, 65]} to={[220, 65]} color="#e67e22" />
      )}
      <text
        x={220}
        y={140}
...
export function WriteThroughDiagram() {
  ...
  return (
    <svg className="w-full" viewBox="0 0 440 150">
      ...
      />
      {step === 0 && (
        <Pkt key="step0" from={[70, 65]} to={[220, 65]} color="#e67e22" />
      )}
      {step === 1 && (
        <Pkt key="step1" from={[220, 65]} to={[370, 65]} color="#e67e22" />
      )}
      {step === 2 && (
        <Pkt key="step2" from={[370, 65]} to={[220, 65]} color="#2ecc71" />
      )}
      {step === 3 && (
        <Pkt key="step3" from={[220, 65]} to={[70, 65]} color="#2ecc71" />
      )}
      <text
        x={220}
        y={140}
