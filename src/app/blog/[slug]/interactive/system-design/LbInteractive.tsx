...
const sections: Section[] = [
  {
    ...
    content: (
      <>
        ...
        <p>They sound similar — and they overlap — but each solves a distinct problem. Understanding when to use which is fundamental to designing resilient systems.</p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Watch the diagram — the client sends HTTPS, but the proxy forwards plain HTTP internally. This is{" "}<strong style={{ color: "var(--primary-color)" }}>SSL termination</strong>{" "}— the proxy handles encryption so your app doesn&apos;t have to.</p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Watch — requests to{" "}<span style={{ color: "#3498db", fontWeight: 500 }}>/users</span>,{" "}<span style={{ color: "#e67e22", fontWeight: 500 }}>/orders</span>, and{" "}<span style={{ color: "#2ecc71", fontWeight: 500 }}>/pay</span>{" "}each route to different backend services.</p>
        <div className="rounded-lg p-4 text-xs space-y-1" style={{ backgroundColor: "var(--card-bg)", border: "1px solid var(--border-color)" }}>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>The simplest strategy is{" "}<strong style={{ color: "var(--accent-color)" }}>Round Robin</strong>: requests go to servers in order — 1 → 2 → 3 → 1 → 2 → 3.</p>
        <div className="rounded-lg p-4 text-xs space-y-1" style={{ backgroundColor: "var(--card-bg)", border: "1px solid var(--border-color)" }}>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Watch the badges — App #2 has only 3 active connections vs 12 and 7. Every new request routes there.</p>
        <div className="rounded-lg p-4 text-xs space-y-1" style={{ backgroundColor: "var(--card-bg)", border: "1px solid var(--border-color)" }}>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Watch what happens — App #2 fails its health check, turns red, and gets pulled from rotation. Traffic automatically reroutes to the remaining healthy servers.</p>
        <div className="rounded-lg p-4 text-xs space-y-1" style={{ backgroundColor: "var(--card-bg)", border: "1px solid var(--border-color)" }}>
        ...
        <p>This is how systems stay available during deployments, crashes, or scaling events — no manual intervention needed.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>Sometimes you need the{" "}<strong style={{ color: "var(--primary-color)" }}>same user to hit the same server</strong> — typically because session state is stored in server memory.</p>
        <p>Watch:{" "}<span style={{ color: "#3498db", fontWeight: 500 }}>User A</span> (blue) always goes to App #1, and{" "}<span style={{ color: "#2ecc71", fontWeight: 500 }}>User B</span> (green) always goes to App #2. The LB uses a cookie or IP hash to maintain affinity.</p>
        <div className="rounded-lg p-4 text-xs space-y-1" style={{ backgroundColor: "var(--card-bg)", border: "1px solid var(--border-color)" }}>
          <p><strong style={{ color: "var(--primary-color)" }}>Trade-off:</strong> If that server dies, the session is lost. This is why stateless architectures (JWTs, Redis sessions) are preferred.</p>
        </div>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Watch the diagram — the L7 LB reads the request path and routes{" "}<span style={{ color: "#9b59b6", fontWeight: 500 }}>/images</span> to App #1,{" "}<span style={{ color: "#e67e22", fontWeight: 500 }}>/api</span> to App #2, and{" "}<span style={{ color: "#1abc9c", fontWeight: 500 }}>/static</span> to App #3. Each path gets its own service.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>These three components often overlap — and in production, you layer them:</p>
        ...
        <p className="font-medium" style={{ color: "var(--primary-color)" }}>Understanding the distinction — and when each layer is needed — is the foundation of designing resilient, scalable backend infrastructure.</p>
      </>
    ),
  },
];
